...
export default function AboutSection3() {
  ...
  return (
    <div className="aboutPagePart3">
      <img src={SHK_4} alt="img7" className="aboutPagePart3__img-7" />
      <img src={SHK_6} alt="img14" className="aboutPagePart3__img-14" />
      <img src={SHK_6} alt="img15" className="aboutPagePart3__img-15" />
